...
const NavbarNews = (props) => {
  return (
    ...
    <div className="container">
        <Link className="navbar-brand" to="/"><strong>JhakazzzNews🌎</strong></Link>
        ...
        <label className="form-check-label" style={{color:'black'}} htmlFor="flexSwitchCheckDefault">{props.text}</label>
        </div>
    </div>
